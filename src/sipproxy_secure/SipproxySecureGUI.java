...
public class SipproxySecureGUI extends JFrame {
  JPanel contentPane;
  JLabel jLabel4 = new JLabel();
  JTextField jTextField4 = new JTextField();
  SipproxySecureListener list;
...
public void appendOngoingTransactionsDisplay(String text) {
  ...
  void jButton2_actionPerformed(ActionEvent e) {
    try{
      ...
      list = new SipproxySecureListener(jTextField1.getText(),Integer.parseInt(t),this,jCheckBox1.isSelected());
    }catch (Exception exc){
...
class SipproxyGUI_jButton2_actionAdapter implements java.awt.event.ActionListener {
  SipproxySecureGUI adaptee;

  SipproxyGUI_jButton2_actionAdapter(SipproxySecureGUI adaptee) {
...
class SipproxyGUI_jCheckBox1_actionAdapter implements java.awt.event.ActionListener {
  ...
  SipproxyGUI_jCheckBox1_actionAdapter(SipproxySecureGUI adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class SipproxyGUI_jButton1_actionAdapter implements java.awt.event.ActionListener {
  ...
  SipproxyGUI_jButton1_actionAdapter(SipproxySecureGUI adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
