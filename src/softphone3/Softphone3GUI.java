...
public class Softphone3GUI extends JFrame {
  JPanel contentPane;
...
public void showStatus(String text) {
  ...
  private void jbInit() throws Exception  {
    ...
    this.setTitle("Internet Multimedia Communications Using SIP. Softphone3");
  ...
  void jButton2_actionPerformed(ActionEvent e) {
    try{
      ...
      list = new Softphone3Listener(config, this, jTextField7.getText());
...
class zphone2GUI_jButton1_actionAdapter implements java.awt.event.ActionListener {
  Softphone3GUI adaptee;

  zphone2GUI_jButton1_actionAdapter(Softphone3GUI adaptee) {
...
class zphone2GUI_jButton2_actionAdapter implements java.awt.event.ActionListener {
  ...
  zphone2GUI_jButton2_actionAdapter(Softphone3GUI adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class zphone2GUI_jButton4_actionAdapter implements java.awt.event.ActionListener {
  ...
  zphone2GUI_jButton4_actionAdapter(Softphone3GUI adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class zphone2GUI_jButton3_actionAdapter implements java.awt.event.ActionListener {
  ...
  zphone2GUI_jButton3_actionAdapter(Softphone3GUI adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Softphone3GUI_jButton6_actionAdapter implements java.awt.event.ActionListener {
  ...
  Softphone3GUI_jButton6_actionAdapter(Softphone3GUI adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Softphone3GUI_jTextField7_actionAdapter implements java.awt.event.ActionListener {
  ...
  Softphone3GUI_jTextField7_actionAdapter(Softphone3GUI adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class Softphone3GUI_jButton5_actionAdapter implements java.awt.event.ActionListener {
  ...
  Softphone3GUI_jButton5_actionAdapter(Softphone3GUI adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
