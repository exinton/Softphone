	...
	public void processInvite(RequestEvent requestEvent,
            ...
            try {
                ...
                if ( !checkProxyAuthorization(request) ) {
                    Response responseauth = messageFactory.createResponse(Response.UNAUTHORIZED,request);

                    WWWAuthenticateHeader wwwAuthenticate = 
                            headerFactory.createWWWAuthenticateHeader(dsam.getScheme());
                    wwwAuthenticate.setParameter("realm",dsam.getRealm(null));
                    wwwAuthenticate.setParameter("nonce",dsam.generateNonce());
                    //wwwAuthenticateImpl.setParameter("domain",authenticationMethod.getDomain());
                    wwwAuthenticate.setParameter("opaque","");
                    wwwAuthenticate.setParameter("stale","FALSE");
                    wwwAuthenticate.setParameter("algorithm",dsam.getAlgorithm());
                    responseauth.setHeader(wwwAuthenticate);
