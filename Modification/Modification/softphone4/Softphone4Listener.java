...
public class Softphone4Listener implements SipListener{
...
static final String transport="tls";


class MyTimerTask extends TimerTask {
        Softphone4Listener myListener;
        public MyTimerTask (Softphone4Listener myListener){
  ...
  public Softphone4Listener(Configuration conf,Softphone4GUI GUI, String sipserver)  {
    try{
      myServer=sipserver;
      myGUI = GUI;
      ...
      SipURI contactURI = myAddressFactory.createSipURI("TLS sever",myIP);	//modify here for tls
       ...
       switch (status) {
         case IDLE:
           if (type == YES) {//make sip phone call
             ...
             myViaHeader = myHeaderFactory.createViaHeader(myIP, myPort,"tls", null);
             ArrayList myViaHeaders = new ArrayList();
             myViaHeaders.add(myViaHeader);
          ...
          //  myVoiceTool.startRx(offerInfo.aport);
           // if (offerInfo.vport!=-1) myVideoTool.startRx(offerInfo.vport,myGUI);
            ...
            //****************************************************
             ...
             ViaHeader myViaHeader = myHeaderFactory.createViaHeader(myIP, myPort,"tls", null);
             ArrayList myViaHeaders = new ArrayList();
             myViaHeaders.add(myViaHeader);
             MaxForwardsHeader myMaxForwardsHeader = myHeaderFactory.
                 createMaxForwardsHeader(70);
