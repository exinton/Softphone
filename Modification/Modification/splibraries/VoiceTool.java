...
<<<<<<< HEAD:src/splibraries/VoiceTool.java
     case 3: af=new AudioFormat(AudioFormat.MPEG_RTP,44100,16,1);
     		break;
     case 4: af=new AudioFormat(AudioFormat.G723_RTP,8000,16,1);
     		break;
     case 5: af=new AudioFormat(AudioFormat.ULAW_RTP,8000,8,1);
=======
...
>>>>>>> xintong:Modification/Modification/splibraries/VoiceTool.java
     	break;		
