...
private final String PROXY_REALM = "nist.gov";
...
  setUserCredentials();//set some user credentials to do user authentication
    try{
...
public void processRequest(RequestEvent requestReceivedEvent) {
  ...
  try{
    if (method.equals(Request.REGISTER)) {
	  ...
	  String pasword = getPassWord(userName);
	  ...
	  /*if(pasword == null)
	  {
          ...
          dsam.generateChallenge(myHeaderFactory, challengeResponse, PROXY_REALM);
